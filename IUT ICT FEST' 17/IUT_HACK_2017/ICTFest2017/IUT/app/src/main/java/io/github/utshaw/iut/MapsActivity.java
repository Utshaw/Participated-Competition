...
//                    }
                ...
                if(item.getItemId() == R.id.bottom_danger){
                    Toast.makeText(MapsActivity.this, "Messsage sent to nearby police station", Toast.LENGTH_SHORT).show();
                }
                if(item.getItemId() == R.id.bottom_near_bus){
                    PlacePicker.IntentBuilder builder = new PlacePicker.IntentBuilder();
